...
var path = require('path'); //Managing paths comes with Node
var chalk = require('chalk'); //Color command line output
var parse = require('react-docgen').parse; //Generating docs linked with the components
var chokidar = require('chokidar'); //watch file and run a function in a cross platform way
...
function generate(paths) {
    ...
    console.log(componentData.length);
